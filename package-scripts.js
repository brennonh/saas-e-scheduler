...
module.exports = {
    scripts: {
        ...
        db: {
            ...
            drop: {
                script: runIfDbEnabled(runFast('./node_modules/typeorm/cli.js schema:drop')),
        ...
        test: {
            default: {
                script: series(
                    'cross-env NODE_ENV=test jest --runInBand --coverage --collectCoverageFrom=src/api/**/*.ts'
                ),
